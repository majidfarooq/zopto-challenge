    ...
    return (
        <>
            <div className="container">
                <div className="row">
                    <div className="col">
                        <button className="btn btn-secondary" onClick={() => navigate('/overview')} >Overview</button>
                    </div>
                    <div className="col">

                    </div>
                    <div className="col txt_rt">
                        <button className="btn btn-secondary" type='button' onClick={() => logOutUserComponent()}>Exit</button>
                    </div>
                </div>
                <div className="row">
                    <div className="col">
                        <button className="btn btn-secondary" type='button' onClick={() => updateEmailsStatus({ user_id, email_id: currentEmailIndex, status: 'Positive Reply' })}>Positive Reply</button>
                    </div>
                    <div className="col txt_cn">
                        <button className="btn btn-secondary" type='button' onClick={() => updateEmailsStatus({ user_id, email_id: currentEmailIndex, status: 'Neutral Reply' })}>Neutral Reply</button>
                    </div>
                    <div className="col txt_rt">
                        <button className="btn btn-secondary" type='button' onClick={() => updateEmailsStatus({ user_id, email_id: currentEmailIndex, status: 'Not A Lead' })}>Not A Lead</button>
                    </div>
                </div>
                <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col">
                        {/* <h4>Subject</h4> */}
                        <p className="eml">{emails.length > 0 && emails[currentEmailIndex].subject}</p>
                        {/* <h4>Body</h4> */}
                        <p className="eml">{emails.length > 0 && emails[currentEmailIndex].body}</p>
                    </div>
                    {/* <div className="col-3">
