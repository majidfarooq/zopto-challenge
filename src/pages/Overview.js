    ...
    return (
        <>
            <div className="container">
                <div className="row">
                    <div className="col">
                        <button className="btn btn-secondary" type='button' onClick={() => resetAllState()}>Reset Application</button>
                    </div>
                    <div className="col">
                        <h3>Overview Page</h3>
                    </div>
...

                {
                    Object.entries(emails).map(([key, value]) => (
                        <div className="row nomar" style={{ border: '1px solid gray' }} key={key}>
                            <div className="col-2">
                                <p>Status: {
